<template>
    <div
        class="w-full bg-pink-100 p-4 rounded mt-4 lg:mt-6"
            ...
            <div class="flex-grow space-y-4">
                <div v-for="(search, key) in enabledFilters" :key="key" class="h-8 flex items-center">
                    <div class="flex-grow relative">
                        <input
                            class="block w-full sm:text-sm rounded-md shadow-sm hover:bg-gray-50 focus:ring focus:ring-pink-200 focus:ring-opacity-50 border-gray-300 focus:border-pink-300 lowercase"
                            type="text"
                            :ref="search.key"
                            :value="search.value"
